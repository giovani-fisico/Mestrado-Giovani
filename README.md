# Design e Validação de Chips Fotônicos para MUBs
...
### **Python (`src/protocolos/`)**
Validação das matrizes encontradas em cenários de uso real utilizando a biblioteca **QuTiP**:

* **`bb84_generalizado.py`**: Simulação Monte Carlo do protocolo de distribuição de chaves quânticas em dimensões $d > 2$.

* **`qrac_generalizado.py`**: Teste de códigos de acesso aleatório quântico (*Quantum Random Access Codes*).
